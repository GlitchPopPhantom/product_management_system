...
def dashboard_stats(request):
    ...
    # References category_id to accurately count categories used by user products
...
class CategoryListCreate(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        # Check the live database at runtime
        queryset = Category.objects.all()
        
        # If the database has 0 categories, seed them instantly on demand
